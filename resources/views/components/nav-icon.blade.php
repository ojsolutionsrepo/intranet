...
@php
    ...
    $key = match (true) {
        str_contains($key, 'dashboard') => 'dashboard',
        str_contains($key, 'director') => 'directory',
        str_contains($key, 'news') => 'news',
        str_contains($key, 'document') => 'documents',
        str_contains($key, 'polic') => 'policies',
        str_contains($key, 'calendar') => 'calendar',
...
<span {{ $attributes->class(['sidebar-link-icon']) }} aria-hidden="true">
    @switch($key)
        @case('dashboard')
