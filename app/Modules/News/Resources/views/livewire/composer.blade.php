<div>
    <form wire:submit="save" class="card p-5 space-y-4">
        ...
        <div>
            <label class="block text-xs font-semibold uppercase tracking-wider text-[var(--ink-500)] mb-1">Body (HTML sanitized on save)</label>
            <textarea wire:model="body_html" rows="10" class="input font-mono text-sm" placeholder="<p>Announcement…</p>"></textarea>
