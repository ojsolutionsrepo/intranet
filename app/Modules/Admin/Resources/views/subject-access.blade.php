...
@section('content')
    <div class="page-form">
        ...
        <form method="POST" action="{{ route('admin.compliance.subject-access.export') }}" class="card p-5 space-y-4">
            @csrf
            <div>
        ...
        <form method="GET" action="{{ route('admin.compliance.audit-export') }}" class="card p-5 space-y-4 mt-6">
